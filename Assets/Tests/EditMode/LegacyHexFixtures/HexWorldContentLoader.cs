...

    {
...

        {
            ...
            if (definition.FactionFlags != null)
...

                {
                    ...
                    if (world.Strategic.Sites.TryGetAtLegacyHex(anchor, out var occupiedSite) && occupiedSite != null)
...

        {
...

            {
                ...
                if (!world.LegacyHexWorld.IsInBounds(hex.Q, hex.R))
                ...
                if (!world.LegacyHexWorld.TryGetCell(hex, out var cell) || cell == null)
...

        {
            ...
            if (site.HasLegacyPresenceAnchorMismatch(loadedPresence))

            {

                System.Diagnostics.Debug.WriteLine(

                    "[HexWorldContentLoader] LegacyPresenceHex != LegacyAnchorHex for site '" + src.SiteId +
