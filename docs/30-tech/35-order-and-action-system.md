...
> 状态：**已冻结并按 ADR-0033／0034／0038 补充授权边界** | 优先级：P0 | 最后更新：2026-09-21
> 依赖：`33` v0.2、`34`、`21`、ADR-0018
> 公开概念只保留 Order／Action；新功能需另行授权。
...
- WorldMap、PlayerParty、NPC Squad 与未来飞舟只能产生各自合法的移动／任务意图，不能通过切换 UI 更换位置权威或凭类型绕过战争／接管条件。FormalArmy 不再是 normal runtime Order producer。
