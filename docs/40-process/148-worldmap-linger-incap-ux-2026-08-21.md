...
> 状态：**已落地；点选纪律由 [152](152-worldmap-rts-click-discipline-2026-08-22.md) 取代 §3.1～3.2**｜日期：2026-08-21；**2026-08-22 修订**  
> 相对提交：`97e3ba7` → **本篇对应提交**  
...
> **已由 [152](152-worldmap-rts-click-discipline-2026-08-22.md) 取代：** 左键可选中；右键＝进入残留战场。下表留作历史。
...
> **已由 [152](152-worldmap-rts-click-discipline-2026-08-22.md) 取代：** 左键只选中；右键（须已选我方活人）仅「攻击」。

| 规则 | 说明（148 旧） |
|------|------|
| 选人 | 左键选活人；无选人不弹攻击菜单 |
| 远处攻击 | **可出菜单、可下令**；**不立刻弹接战** |
| 到站 | 宏观追击／移动 → **与栈重合** 后弹接战 |
| 弥留敌军 | 同一套 Offer |
...
| 日期 | 说明 |
|------|------|
| 2026-08-22 | **点选纪律废止 §3.1～3.2 旧表**，改跟 [152](152-worldmap-rts-click-discipline-2026-08-22.md) |
