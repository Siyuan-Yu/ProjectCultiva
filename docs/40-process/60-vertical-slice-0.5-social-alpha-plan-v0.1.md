...
> 状态：**已验收（见 [63](63-vertical-slice-0.5-alpha-acceptance.md)）**｜最后更新：2026-08-01  
...
| V5-B | RelationshipLedger／Service／缓存 | `4205430` ✅ |
| V5-C | 开局关系种子 + Help／Slight | `34f6e4c` ✅ |
| V5-D | FactionMembership + RecruitService | `2663ffd` ✅ |
| V5-E | 人格日程偏置 | `4e24d39` ✅ |
| V5-F | 社会 Tick 漂移 | `c4799d9` ✅ |
| V5-G | Alpha 整合验收 | `53ff0bf` ✅ |
...
见实现中 `SocialAlphaConstants`：初始关系分、招募门槛、日程偏置、社会 Tick 间隔等；变更记 Devlog。
