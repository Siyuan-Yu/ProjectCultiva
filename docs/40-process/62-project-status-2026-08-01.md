...
> 用途：一次看清 VS0.1～0.5 做到哪、本轮改了什么、下一步是什么。  
...
| VS0.6 | **已验收** | [64](64-vertical-slice-0.6-playable-social-host-plan-v0.1.md)／[65](65-vertical-slice-0.6-acceptance-report.md) | Social 接入 Unity Host |
