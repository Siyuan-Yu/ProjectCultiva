...
- **MAP-04 已验收／封板：** WorldGraphEditor、RegionEditor 与 editor-only Shared/HexWorld 已移除，Chunk 与 normal Gameplay 已退出旧 MapLayout／Hex／Outdoor LocalMap authority。仍保留者只限独立空间、旧输入、明确 compatibility、工具或测试契约；审计记录见 [245](../245-map-04-physical-legacy-cleanup-2026-09-17.md)。本 ADR 下方的“未实施”描述是 2026-09-15 的历史 Context，不覆盖本节状态。
