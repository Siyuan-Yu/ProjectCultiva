...
> 日期：2026-09-15
> 状态：**Accepted Direction；MAP-01 / MAP-02 / MAP-03 已 Producer Accepted / Sealed；MAP-04 Implementation In Progress**
> 决策者：制作人
...
- **MAP-04 实施中：** WorldGraphEditor、RegionEditor 与 editor-only Shared/HexWorld 已移除；正式 Build All 现为 10 个 Editor。Chunk 已退出旧 MapLayout source；其它 Hex / Outdoor LocalMap Content 删除仍受 runtime consumer 约束。当前审计和未通过的 gate 见 [245](../245-map-04-physical-legacy-cleanup-2026-09-17.md)。本 ADR 下方的“未实施”描述是 2026-09-15 的设计时 Context，不覆盖本节状态。
