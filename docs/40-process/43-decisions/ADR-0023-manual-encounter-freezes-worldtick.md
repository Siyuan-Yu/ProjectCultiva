...
> **PARTIALLY SUPERSEDED（2026-09-12）：** [ADR-0033](ADR-0033-source-faithful-independent-encounter-and-world-anchor-return.md) 替代本 ADR 的战后 `BattleAnchor` 位置规则：所有参与者各回自己的战前世界锚点，但伤亡、消耗、关系、宣战、建筑损伤与接管保留。WorldTick 唯一轴、主世界冻结、AutoResolve 不推进世界时间等规则继续有效。
