...
| 操作 | 行为 |
|------|------|
| **左键头像** | 选中/多选己方角色（含弥留头像可选中，见 [152](152-worldmap-rts-click-discipline-2026-08-22.md)） |
| **右键节点** | 确认弹窗 → **立刻**出发到该节点（多段路径自动续走） |
| **右键道路** | 确认弹窗 → **立刻**出发到路上指定进度 |
| **右键敌军/他方栈** | **仅「攻击」**（须已选可下令活人；右键不改选中，见 152） |
...
| 菜单项 | 行为 |
|--------|------|
| **攻击** | 登记追击 → 已重合则 BattleOffer；否则立刻上路，**每 tick 贴敌军栈当前宏观位置**，追上再弹窗 |

「查看详情」已删。点选纪律见 [152](152-worldmap-rts-click-discipline-2026-08-22.md)。
