...
> 后续接续：资源建造、主动拆除与正式 UI 入口已由 [LocalMap 建造系统 V1 封板记录](201-localmap-construction-v1-sealed-2026-09-06.md) 接管；本页关于早期免费立旗／未来 Flag Construction 的描述仅代表当时阶段。
...
- 立旗：本页封板时使用合法 Wilderness LocalMap placement；其后正式 Gameplay 入口与资源成本已由 [201](201-localmap-construction-v1-sealed-2026-09-06.md) 接管。Domain gate 继续要求合法 Anchor、至少新增有效无主控制，并允许 Nominal overlap。
...
- **FactionFlag 建造**：资源成本与主动拆除已由 [201](201-localmap-construction-v1-sealed-2026-09-06.md) 的即时 Construction V1 实现；建造时间与施工过程仍属后续范围。
