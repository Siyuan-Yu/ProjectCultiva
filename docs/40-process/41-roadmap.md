...
> **当前 WIP（2026-09-21）：LEGACY-FINAL-B — PlayerParty Continuous Surface Travel Authority Cutover。** LEGACY-FINAL-A 已由制作人验收并正式 **Accepted / Sealed**，记录见 [248](248-legacy-final-a-unified-npc-squad-world-motion-2026-09-20.md)，已验收实现 checkpoint 为 `e97f53f`。B 完成后进入 LEGACY-FINAL-C；B/C 全部完成前不得宣称 Legacy migration complete。
...
> **当前唯一主线（2026-09-21）：** 已封板 CW-U0～CW-10.5、MAP-01～MAP-04、SPACE-01 与 LEGACY-FINAL-A；当前实施 LEGACY-FINAL-B，随后为 LEGACY-FINAL-C。
