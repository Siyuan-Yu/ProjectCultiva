...
最新增量见 [141](../40-process/141-pursuit-stick-and-multi-melee-2026-08-18.md)；收束 [140](../40-process/140-world-map-rts-battle-return-rollup-2026-08-18.md)；规则 [139](../40-process/139-world-map-rts-orders-2026-08-17.md)。  

**下一步：** 手操验追击贴敌与群殴 → 跟随菜单／交谈仍暂缓 → **正式占点／外交另开刀**（当前刻意关掉）。  
Demo Runtime 停扩。完整进度见 [62 项目现状](../40-process/62-project-status-2026-08-01.md)。

**建议先读：** [通读指南](04-reading-guide.md) → 本页 → [141](../40-process/141-pursuit-stick-and-multi-melee-2026-08-18.md) → [140 收束](../40-process/140-world-map-rts-battle-return-rollup-2026-08-18.md) → [62 现状](../40-process/62-project-status-2026-08-01.md) → [33](../30-tech/33-architecture-core-rules-freeze-v0.2.md)。
