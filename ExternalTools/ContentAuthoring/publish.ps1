...
$apps = @("PackageBrowser", "RegionEditor", "LocalPlaceEditor", "ManualArtEditor", "WorldGraphEditor", "QuestEditor", "EventEditor", "MapEditor", "WorkAreaEditor", "CharacterNpcEditor")
foreach ($app in $apps) {
